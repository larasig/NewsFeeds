...
{
    public class WebScraper_VirusOrg : RssFeedWebScraper
    {
        public WebScraper_VirusOrg(String feedUrl, Int32 sourceId, Encoding sourcePageEncoding = null)
        ...
        protected override string GetContent(string rawHtml)
        {
            ...
            const String contentElemId = "blog_post";
            ...
            foreach (var n in mainNode.Elements("p"))
            {
